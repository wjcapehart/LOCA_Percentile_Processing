...
program LOCA_Colate_to_HUCS
  ...
  real (kind=4), dimension(nlon,nlat) :: map_pr_2d, map_tasmax_2d, map_tasmin_2d
  ...
  print*, "Ready to run with ", num_threads, " threads"
    ...
    do e = 1, nens
      ...
      do tt = 1, n_reads
        ...
        do t = 1,  span_t(tt), 1
          ...
          map_tasmax_2d = map_tasmax(:,:,t)
          map_tasmin_2d = map_tasmin(:,:,t)
          map_pr_2d     = map_pr(:,:,t)


!$OMP PARALLEL DO PRIVATE(h, mask_map, sort_tasmax, sort_tasmin, sort_pr, masked_variable_map, linear_array), &
!$OMP&             SHARED(caldate, ensembles, unit_huc, hucs, myhuc_low, myhuc_high, pr_FillValue, tasmax_FillValue), &
!$OMP&             SHARED(e, s, tasmin_FillValue, nhuccells, map_pr_2d, map_tasmax_2d, map_tasmin_2d)
          do h = 1, nhucs, 1
            ...
            if ((hucs(h) .ge. myhuc_low) .and. (hucs(h) .le. myhuc_high)) then
              ...
              mask_map = merge(1,0, (huc_map       .eq.          hucs(h)) .and. &
                                    (map_pr_2d     .ne.     pr_FillValue) .and. &
                                    (map_tasmax_2d .ne. tasmax_FillValue) .and. &
                                    (map_tasmin_2d .ne. tasmax_FillValue)       )
              ...
              !!! tasmax
                ...
                masked_variable_map = map_tasmax_2d
              ...
              !!! tasmin
                ...
                masked_variable_map = map_tasmin_2d
