...
nohup gzip -v /maelstrom2/LOCA_GRIDDED_ENSEMBLES/LOCA_NGP/huc_08_basins/done/*.csv >& post_gzip_huc.txt
nohup gzip -v /maelstrom2/LOCA_GRIDDED_ENSEMBLES/LOCA_NGP/climate_divisions/done/*.csv >& post_gzip_huc.txt
