...
thredds_root= "http://kyrill.ias.sdsmt.edu:8080/thredds/fileServer/LOCA_NGP/Specific_Regional_Aggregate_Sets/huc_08_basins/R_Yearly_Files/"
...
ensembles =  unique(loca$Ensemble)
    ...
    print(length(ensembles))
       out_dir = str_c("~/Desktop/",
        ...
        outxlsx = str_c(out_dir,"LOCA_pr_",basin,"_Yearly.xlsx",sep="")
