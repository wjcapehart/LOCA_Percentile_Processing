...
{  # huc
  ...
  loca_location_data = HUC08_MRB_LUT %>%
    ...
    root_LOCA_URL = "http://kyrill.ias.sdsmt.edu:8080/thredds/fileServer/LOCA_NGP/Specific_Regional_Aggregate_Sets/huc_08_basins/R_Daily_Files/problems/"
