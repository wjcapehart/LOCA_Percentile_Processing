...
!$OMP&             SHARED(e, s, caldate, ensembles, unit_huc, hucs, myhuc_low, myhuc_high, pr_FillValue, tasmax_FillValue), &
!$OMP&             SHARED(tasmin_FillValue, nhuccells, map_pr_2d, map_tasmax_2d, map_tasmin_2d)
          do h = 1, nhucs, 1
