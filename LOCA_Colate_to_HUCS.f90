program LOCA_Colate_to_HUCS
  ...
  integer (kind=4) :: myhuc_low    = 10230003  ! 10170000 (Big Sioux) !  10120000 (Chey)  !  10160000 (James)
  integer (kind=4) :: myhuc_high   = 10230003   ! 10170000 (Big Sioux) !  10120000 (Chey)  !  10160000 (James)
