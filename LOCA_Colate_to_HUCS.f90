program LOCA_Colate_to_HUCS
  ...
  integer (kind=4) :: myhuc_low    = 10050011   ! 10170000 (Big Sioux) !  10120000 (Chey)  !  10160000 (James)
  integer (kind=4) :: myhuc_high   = 10050011   ! 10170000 (Big Sioux) !  10120000 (Chey)  !  10160000 (James)
