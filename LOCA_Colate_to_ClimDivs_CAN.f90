program LOCA_Colate_to_ClimDivs_CAN
...
"Specific_Regional_Aggregate_Sets/climate_divisions/R_Daily_Files/work/NGP_LOCA_nCLIMDIV_"
  ...
  integer (kind=4) :: myhuc_low    = 47255
  ...
  !  num_procs = 1
   ...
   print*, "OMP Threads at start = ", num_procs
...
!!!!!!!!!!!!!!!!  Get input_map
  ...
  do h = 1, nhucs
    ...
    if ((hucs(h) .ge. myhuc_low) .and. (hucs(h) .le. myhuc_high)) then
      ...
      write(basin_file_name,'(A, I5.5)') trim(file_output_root), myhucs(t)
      write(*,'("h:",I3.3," u:",I3.3," Div:",I5.5," size:",I8," ",A)') t, &
                                                                       unit_huc(t), &
                                                                       myhucs(t), &
                                                                       nhuccells(t), &
  ...
  do s = start_scen, end_scen ! 1, nscen
    ...
    do h = 1, nmyhucs
      ...
      write(csv_filename(h),'(A, I5.5,"_",A,".csv")') trim(file_output_root), myhucs(h), trim(scenarios(s))
      write(*,'("h:",I3.3," u:",I3.3," Div:",I5.5," size:",I8," ",A)') h, &
                                                                       unit_huc(h), &
                                                                       myhucs(h), &
                                                                       nhuccells(h), &
                                                                       trim(csv_filename(h))
...
!print*, "proc:(",omp_get_thread_num(),":",num_procs,") caldat: ",trim(caldate)," HUC:",myhucs(h)
              ...
              !!! output
                ...
                write(output_buffer(t_buffer),'(A,",",I5.5,3(",",A),3(",",F8.2))')  &
                            trim(caldate), &
                            myhucs(h), &
                            trim(ensembles(e)), &
                            trim(scenarios(s)), &
                ...
                write(output_buffer(t_buffer+1),'(A,",",I5.5,3(",",A),3(",",F8.2))')  &
                            trim(caldate), &
                            myhucs(h), &
                            trim(ensembles(e)), &
                            trim(scenarios(s)), &
                ...
                write(output_buffer(t_buffer+2),'(A,",",I5.5,3(",",A),3(",",F8.2))')  &
                            trim(caldate), &
                            myhucs(h), &
                            trim(ensembles(e)), &
                            trim(scenarios(s)), &
                ...
                write(output_buffer(t_buffer+3),'(A,",",I5.5,3(",",A),3(",",F8.2))')   &
                            trim(caldate), &
                            myhucs(h), &
                            trim(ensembles(e)), &
                            trim(scenarios(s)), &
                ...
                write(output_buffer(t_buffer+4),'(A,",",I5.5,3(",",A),3(",",F8.2))')  &
                            trim(caldate), &
                            myhucs(h), &
                            trim(ensembles(e)), &
                            trim(scenarios(s)), &
                ...
                write(output_buffer(t_buffer+5),'(A,",",I5.5,3(",",A),3(",",F8.2))')  &
                            trim(caldate), &
                            myhucs(h), &
                            trim(ensembles(e)), &
                            trim(scenarios(s)), &
...
end program LOCA_Colate_to_ClimDivs_CAN
